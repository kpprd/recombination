...
investigation = Investigation("ABCDEFGHI", model="free", interference_parameters = 1, interference_bounds = (0,20), include_patterns_in_report = False, extra_pathway= False, beta = 0, output_file = "morgan_results.txt", error2 = 1e-6, error1 = 1e-6)
