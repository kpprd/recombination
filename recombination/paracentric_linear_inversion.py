...
investigation = Investigation("A[BCDE]@", model="free", extra_pathway= False, interference_parameters = 1, interference_bounds = (0,20), alpha = 0, beta = 0, include_breakpoint_loci = False, include_patterns_in_report= True, output_file="results/sturtevant_sc8_unbalanced_results.txt", interference_direction = "original", linear_meiosis= True, error2 = 1e-6)
